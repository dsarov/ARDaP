...
pMetaDataPath <- file.path(output_path, "patientMetaData.csv")
pSuscData <- file.path(output_path, "patientDrugSusceptibilityData.csv")
sweaveRep <- file.path(output_path, "sweaveTB-WGS-Micro-Report.Rnw")
AbReport <- file.path(output_path)
