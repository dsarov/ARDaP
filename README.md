...
ARDaP (Antimicrobial Resistance Detection and Prediction) is a genomics pipeline for the comprehensive identification of antibiotic resistance from whole-genome
sequencing data. The impetus behind the creation of ARDaP was the frustration with current methods focusing on the presence of single genes copnfering resistance
without much focus on chromosomal resistance determinants. 
